...
BENCHMARK(BM_MONGO_Insert)->Apply(CustomArgumentsInserts)->UseRealTime()->Complexity()->ThreadRange(1,4);
...
BENCHMARK(BM_MONGO_InsertTransact)->Apply(CustomArgumentsInserts)->UseRealTime()->Complexity()->ThreadRange(1,4);
