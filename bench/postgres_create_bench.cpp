...
BENCHMARK(BM_PQXX_Insert)->Apply(CustomArgumentsInserts)->UseRealTime()->Complexity()->ThreadRange(1, 4);
...
BENCHMARK(BM_PQXX_InsertTransact)->Apply(CustomArgumentsInserts)->UseRealTime()->Complexity()->ThreadRange(1, 4);
